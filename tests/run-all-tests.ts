...
function runTestSuite(suite: TestSuite): { success: boolean; duration: number; output: string } {
...
function generateReport(results: Array<{ suite: TestSuite; success: boolean; duration: number }>) {
...
async function main() {
  ...
  const results: Array<{ suite: TestSuite; success: boolean; duration: number }> = [];
